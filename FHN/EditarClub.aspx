<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarClub.aspx.cs" Inherits="FHN.EditarClub" %>
    ...
    <div class="container">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-md-offset-2">
                    <asp:DropDownList ID="ddlClub" runat="server"
                        ...
                        <asp:ListItem Value="-1">&lt;Seleccione un Club&gt;</asp:ListItem>
                    </asp:DropDownList>
                </div>
            </div>
            <!--ID INTERNO-->
        ...
        <div class="form-group">
            <div class="col-md-2 col-md-offset-2">
                <br />
                <asp:Button ID="btnActualizarClub" runat="server" Text="Actualizar" CssClass="boton_azul" OnClick="btnActualizarClub_Click" />
            </div>
        </div>
    </div>
</asp:Content>
